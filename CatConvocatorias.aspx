...
<asp:Content ID="Content2" ContentPlaceHolderID="CSS" runat="Server">
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            Sys.Application.add_load(function (s, e) {
                ...
                $('#ajax').on('hidden.bs.modal', function () {
                    ...
                    $('#ajaxidmodal').addClass("hidden");
                    $('#ajaxmodalloading').removeClass("hidden");
                });
                $('#ajaxidmodal').addClass("hidden");
                $('#ajaxmodalloading').removeClass("hidden");
        ...
        function FiltrarTabla(idtxt, idtable) {
            if ($('#' + idtxt).val() == '') { $('table#' + idtable + ' tr').css('display', 'table-row'); }
            else { $('table#' + idtable + ' tr').css('display', 'none'); $('table#' + idtable + ' tr:contains("' + $('#' + idtxt).val() + '")').css('display', 'table-row'); }
        }
